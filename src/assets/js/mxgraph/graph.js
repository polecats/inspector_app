...
function main(container)
{
    ...
    else
    {
        ...
        try
        {
            var v1 = graph.insertVertex(parent, null, 'Error Occured,', 20, 20, 80, 30);
            var v2 = graph.insertVertex(parent, null, 'Error Occured!', 200, 150, 80, 30);
...
(function()
{
    ...
    var touchHandle = new mxImage('assets/js/mxgraph/images/handle-main.png', 17, 17);
    ...
    var connectorSrc = 'assets/js/mxgraph/images/handle-connect.png';
...
graphHelper.prototype.load = function() {
    // Passes the container for the graph to the program 
    main(document.getElementById('graphContainer'));
};

// graphHelper.prototype.shit = function() {
//     alert('shit');
// };
